...
It is similar to prediction accuracy in that it indicates how well the sytem does in general, but keep in mind that they're measuring two completely different concepts. Although a system with a good prediction accuracy also has a good detection accuracy, it might be possible that a system very good at predicting confusibles in errorless texts behaves differently in texts that do contain errors.
