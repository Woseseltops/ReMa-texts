...
Unfortunately, when investigating its effects in a full translation setting, it turned out the skipgrams do not seem to improve the translation quality, because the decoder mostly picks the translation hypotheses consisting of sentences formed without skipgrams.

So far, the experiments have not yet shown an improvement in translation quality, but the researchers are hopeful in achieving this in the future. They also want to add support for skipgrams in this stage.




\section{Main outstanding questions and future research}
